...
{
    public partial class Item_and_Prices : UserControl
    {
        public Item_and_Prices()
        {
            InitializeComponent();
        }

        private static Item_and_Prices _instance;

        public static Item_and_Prices Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new Item_and_Prices();
                return _instance;
            }
        }
        ...
        private void Item_and_Prices_Load(object sender, EventArgs e)
        {
        ...
        public void display_VATDetails()
        {
            //displaying the corresponding product details like group name , sub group name from the datatable Group_Details
            SqlCommand cmd1 = conn.CreateCommand();
            cmd1.CommandType = CommandType.Text;
            cmd1.CommandText = "select * from Group_Detail where [Sub Category] = '" + itmPrcSubGropNm.Text + "'";
        ...
        //inserting corresponding sub category of the Main Category

        private void itmPrcSubGropNm_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            foreach (DataRow dr1 in dt1.Rows)
            {
                itmPrcSubGropNm.Items.Add(dr1["Category"].ToString());
            }
        }
