    ...
    public partial class Client_View : UserControl
    {
        ...
        public void disp()
        {
            ...
            if (comboBox1.Text == "")
            {
                ...
                cmd4.CommandText = "Select * from Order_User";
            ...
            else
            {
                ...
                cmd5.CommandText = "Select * from Order_User where Customer = '" + comboBox1.Text + "'";
        ...
        public void fill_product_name()
        {
            ...
            foreach (DataRow dr1 in dt1.Rows)
            {
                ...
                comboBox1.Items.Add(dr1["Customer"].ToString());
            }
        }
        ...
        void AutoComplete_Text1()
        {
            ...
            cmd14.CommandText = "select * from Order_User ";//selecting from the table in sql server
